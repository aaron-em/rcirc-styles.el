...
TEST_DEP_2=rcirc
TEST_DEP_2_STABLE_URL=http://git.savannah.gnu.org/cgit/emacs.git/plain/lisp/net/rcirc.el?h=emacs-24.3
TEST_DEP_2_LATEST_URL=http://git.savannah.gnu.org/cgit/emacs.git/plain/lisp/net/rcirc.el?h=master
